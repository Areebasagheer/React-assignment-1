  ...
  return (
    <>
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img src="public/img/first.jpg" className="card-img-top" width="100%" height="225" alt="..." />
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img src="public/img/second.jpg" className="card-img-top" width="100%" height="225" alt="..." />
                  <div className="card-body">
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img src="public/img/third.jpg" className="card-img-top" width="100%" height="225" alt="..." />
                  <div className="card-body">
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img src="public/img/fourth.jpg" className="card-img-top" width="100%" height="225" alt="..." />
                  <div className="card-body">
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img src="public/img/fifth.jpg" className="card-img-top" width="100%" height="225" alt="..." />
                  <div className="card-body">
              ...
              <div className="col">
                <div className="card shadow-sm">
                  <img src="public/img/sixth.jpg" className="card-img-top" width="100vh" height="225" alt="..." />
                  <div className="card-body">
      ...
      <div className="px-4 py-5 text-center background2">
        ...
        <br />
        <br />
        <img src="public/img/seventh.jpg" className="d-block mx-lg-auto mb-4 img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy" />
